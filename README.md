...
This marathon is based on eSim, an open-source EDA tool for circuit design, simulation, and PCB design, developed by [FOSSEE](https://www.linkedin.com/company/fossee-iitb/), IIT Bombay in collaboration with [Google](https://www.linkedin.com/company/google/) and [VLSI System Design](https://www.linkedin.com/company/vlsi-system-design/) Corp. Pvt. Ltd. In this marathon, more than 2700 people participated among which about 100 participants were selected as accepted ones. The final result is announced at https://hackathon.fossee.in/esim/results.
